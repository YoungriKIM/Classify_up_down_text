# 모델 끝에 예측까지 같이 해보기로 함
# p_04_predict 와 차이 없음. p_04 이용하도록~
...
# =========================================================
# 예측하기
sentiment_predict('더 이상 기다릴 수 없어요!')
# 100.00 % 확률로 존댓말입니다.
sentiment_predict('만가서 반갑습니다 김영리에요.')
# 99.98 % 확률로 존댓말입니다.
sentiment_predict('우리 같이 코딩 합시다')
# 96.24 % 확률로 존댓말입니다.
sentiment_predict('존댓말에도 여러가지 종류가 있다는 걸 기억하십시오')
# 71.37 % 확률로 반말입니다.
sentiment_predict('내가 이렇게 반말해도 넌 모르겠지')
# 98.55 % 확률로 반말입니다.
sentiment_predict('내가 점점 미쳐가나봐')
# 97.10 % 확률로 반말입니다.

# p_04_predict 랑 같은 결과 나옴, p_04 파일에 문제 없음